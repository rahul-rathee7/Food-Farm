...
const Cards = () => {
  return (
    ...
    <div className='grid grid-cols-5 gap-3 bg-white h-full w-full p-2 rounded-3xl'>
        ...
        <div className=' flex flex-col gap-5 bg-white rounded-xl px-2 py-4  w-full'>
            <Image className='bg-gray-300 p-4 rounded-xl h-3/4' src={avacado} alt="strawberry" />
            <div className='px-3 mt-2' >
        ...
        <div className='flex flex-col gap-5 bg-white rounded-xl px-2 py-4 h-full w-full'>
            <Image className='bg-gray-300 p-4 rounded-xl h-3/4' src={s} alt="strawberry" />
            <div className='px-3 mt-2' >
                <p className='text-black font-semibold text-2xl  '>Fresh Strawberry</p>
                    <div className='flex justify-evenly text-2xl'>
                        <span className='flex'><p className='text-gray-500 line-through'>₹120</p><p className='text-black px-3'><b>₹90</b></p></span>
